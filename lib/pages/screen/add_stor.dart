  ...
  void _onAddButtonPressed() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (_image != null) {
        ...
        await _image!.readAsBytes().then((value) => ByteData.view(Uint8List.fromList(value).buffer));
        final String fileName = '${DateTime.now().toIso8601String()}.jpg'; // Set the file name to the current date and time
        ...
        final String imagePath = '${appDirectory.path}/$fileName'; // Use the appDirectory path to store the image file
        ...
        _img = imagePath.replaceAll('""', ''); // Set the _img variable to the image file name
      }
